...
CSVStream.prototype.parse = function (data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (c === this.quote && this._prev[0] === '\\') {
      this._prev.shift();
      this._field = this._field.replace(/\\/g,"");
      this._prev.push(this._field.charAt(this._field.length - 3));
      if (!this._isQuoted || this._prev[1] === this.delimiter) {
        this._isQuoted = true;
      }
      continue
    }
    ...
    if (this._prev[2] === this.delimiter && !this._isQuoted && this._prev[0] !== this.quote && this._prev[1] === this.quote) {
      this._isQuoted = true;
    }
